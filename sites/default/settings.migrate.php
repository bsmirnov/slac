 ...
 * on Thu, 24 Jun 2021 21:38:05 -0700.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $conf['file_public_path'] = 'sites/communications.internal.slac.stanford.edu/files';
  $conf['file_temporary_path'] = 'sites/communications.internal.slac.stanford.edu/private/temp';
    $conf['file_private_path'] = 'sites/communications.internal.slac.stanford.edu/private/files';
    $conf['clean_url'] = 1;
  $conf['aegir_api'] = 0;
...
$conf["file_temporary_path"] = '/afs/slac.stanford.edu/g/web/drupal/6997/private/temp';

$conf["file_private_path"] = '/afs/slac.stanford.edu/g/web/drupal/6997/private/files';
  ...
  if (file_exists('/var/aegir/platforms/cm-prod-2/sites/communications.internal.slac.stanford.edu/local.settings.php')) {
    include_once('/var/aegir/platforms/cm-prod-2/sites/communications.internal.slac.stanford.edu/local.settings.php');
  }