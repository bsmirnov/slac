 ...
 * on Wed, 23 Jun 2021 22:11:55 -0700.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  $db_url['default'] = $_SERVER['db_type'] . '://' . $_SERVER['db_user'] . ':' . $_SERVER['db_passwd'] . '@' . $_SERVER['db_host'] . ':' . $_SERVER['db_port
'] . '/' . $_SERVER['db_name'];
}
...
$conf['file_public_path'] = 'sites/cryoem.slac.stanford.edu/files';
$conf['file_temporary_path'] = 'sites/cryoem.slac.stanford.edu/private/temp';
$conf['file_private_path'] = 'sites/cryoem.slac.stanford.edu/private/files';
$conf['clean_url'] = 1;
$conf['aegir_api'] = 0;
...
$conf["file_temporary_path"] = '/afs/slac.stanford.edu/g/web/drupal/11040/private/temp';

$conf["file_private_path"] = '/afs/slac.stanford.edu/g/web/drupal/11040/private/files';
  ...
  if (file_exists('/var/aegir/platforms/cm-prod-2/sites/cryoem.slac.stanford.edu/local.settings.php')) {
    include_once('/var/aegir/platforms/cm-prod-2/sites/cryoem.slac.stanford.edu/local.settings.php');
  }
